...
siblings keep full values ([`src/options.rs`](../src/options.rs)).
...
"defined" by its own declaration ([`src/schema.rs`](../src/schema.rs)).
...
([`src/schema.rs`](../src/schema.rs), built in
...
graph ([`src/schema.rs`](../src/schema.rs),
[`src/manifest.rs`](../src/manifest.rs)).
...
the inherited bulk ([`src/schema.rs`](../src/schema.rs)).
...
grafts, and warnings ([`src/schema.rs`](../src/schema.rs), built in
[`src/manifest.rs`](../src/manifest.rs)).
...
alongside the extractor version ([`src/cache.rs`](../src/cache.rs)).
...
customized styling ([`src/schema.rs`](../src/schema.rs)).
...
re-evaluated ([`src/cache.rs`](../src/cache.rs)).
