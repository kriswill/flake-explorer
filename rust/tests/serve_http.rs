// Integration test of the serve layer — port of the bun suite's
// serve.test.ts: routing + the on-demand single-flight extraction, hermetic
...
// fn, mirroring the bun file's deliberately state-dependent test order; env
